...
/*!**************************!*\
  !*** ./src/dom-utils.js ***!
  \**************************/
/*! exports provided: clearContents, updateContents, qrySelect, mainContainer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"clearContents\", function() { return clearContents; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"updateContents\", function() { return updateContents; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"qrySelect\", function() { return qrySelect; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"mainContainer\", function() { return mainContainer; });\nconst qrySelect = document.querySelector.bind(document);\nconst mainContainer = qrySelect('#content');\n\nfunction clearContents(container) {\n  while (container.firstChild) {\n    container.removeChild(container.firstChild);\n  }\n}\n\nfunction updateContents(contents) {\n  const fragment = document.createDocumentFragment();\n  contents.forEach(element => fragment.appendChild(element));\n  clearContents(mainContainer);\n  mainContainer.appendChild(fragment);\n}\n\n\n\n\n//# sourceURL=webpack:///./src/dom-utils.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _fader__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./fader */ \"./src/fader.js\");\n/* harmony import */ var _dom_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dom-utils */ \"./src/dom-utils.js\");\n/* harmony import */ var _about_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./about-page */ \"./src/about-page.js\");\n/* harmony import */ var _dishes_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./dishes-page */ \"./src/dishes-page.js\");\n/* harmony import */ var _contact_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./contact-page */ \"./src/contact-page.js\");\n\n\n\n\n\n\nlet currentPage;\n\nfunction swapContents(populateFn, page) {\n  return () => {\n    if (page !== currentPage) {\n      Object(_fader__WEBPACK_IMPORTED_MODULE_0__[\"fadeSwap\"])(_dom_utils__WEBPACK_IMPORTED_MODULE_1__[\"mainContainer\"], populateFn, 42);\n      currentPage = page;\n    }\n  };\n}\n\nfunction setMenuItemEventListener(selector, contentsFn, page) {\n  Object(_dom_utils__WEBPACK_IMPORTED_MODULE_1__[\"qrySelect\"])(selector).addEventListener('click', swapContents(contentsFn, page));\n}\n\nfunction run() {\n  setMenuItemEventListener('#about', _about_page__WEBPACK_IMPORTED_MODULE_2__[\"default\"], 1);\n  setMenuItemEventListener('#dishes', _dishes_page__WEBPACK_IMPORTED_MODULE_3__[\"default\"], 2);\n  setMenuItemEventListener('#contact', _contact_page__WEBPACK_IMPORTED_MODULE_4__[\"default\"], 3);\n\n  Object(_about_page__WEBPACK_IMPORTED_MODULE_2__[\"default\"])();\n  currentPage = 1;\n\n  Object(_fader__WEBPACK_IMPORTED_MODULE_0__[\"fadeIn\"])(document.getElementsByTagName('body')[0], 50);\n}\n\nrun();\n\n\n//# sourceURL=webpack:///./src/index.js?");
